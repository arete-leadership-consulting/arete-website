  ...
  return <PageShell>
    ...
    <section className="legal-page section">
      ...
      <div className="legal-copy">
        <section><h2>Information we collect</h2><p>When you use the inquiry form, ARETE collects the name, work email address, organization, and message you choose to provide. Basic technical information may also be processed as needed to deliver, secure, and maintain the website.</p></section>
